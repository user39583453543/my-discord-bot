...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addAttachmentOption((opt) =>
      opt
        .setName("image")
        .setDescription("Image/GIF to show in the embed")
        .setRequired(false),
    )
    .addAttachmentOption((opt) =>
      opt
        .setName("thumbnail")
        .setDescription("Small thumbnail image (top right)")
        .setRequired(false),
    )
    .addStringOption((opt) =>
      opt
        .setName("color")
        .setDescription("Override color: gold (default) or black")
        .addChoices(
