...
async function getPlayerRecentSessions(playerId, pageSize = 50) {
...
module.exports = { searchServers, getServer, searchPlayers, getPlayer, getPlayerSessions, getPlayerCurrentServer, getPlayerBySteamId, getPlayerRecentSessions };
